function [all_col4_proc_rads,ng2_proc_rads,col4_only_proc_rads] = skel_2_proc_segs(bw_skel,...
...
col4_only_proc_rads = mean(all_proc_seg_rads(~ng2_bv));
all_col4_proc_rads = mean(all_proc_seg_rads);
